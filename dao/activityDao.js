...
function getUserSignUpActivity(object) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        pool.getConnection(function (err, connection) {
            ...
            connection.query('SELECT * FROM (wb_activity_user_signup_relation'
                + ' INNER JOIN wb_activity ON wb_activity.activity_id = wb_activity_user_signup_relation.activity_id) INNER JOIN wb_user ON wb_activity.open_id = wb_user.open_id' +
